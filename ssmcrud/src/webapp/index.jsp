...
<head>
    ...
    %>
    <!-- 不以/开始的相对路径，找资源，以当前资源的资源为基准，经常容易出问题
...
<script type="text/javascript">
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                //console.log(result);
                // "extend":{"depts":[{"deptId":1,"deptName":"开发部"},{"deptId":2,"deptName":"测试部"},{"deptId":5,"deptName":"业务部"}]}}
