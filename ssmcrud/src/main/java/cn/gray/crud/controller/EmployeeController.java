package cn.gray.crud.controller;


import cn.gray.crud.bean.Employee;
import cn.gray.crud.bean.Msg;
import cn.gray.crud.service.EmployeeService;
...
public class EmployeeController {
     ...
     * AJAX发送PUT请求  Tomcat不会封装PUT请求中的数据为map  POST形式的请求才封装请求为map
     * 解决方案：
